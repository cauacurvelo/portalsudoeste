        ...
        <div className="w-full bg-[#0F1442] h-9 flex items-center overflow-hidden">
            <div className="flex items-center h-full w-full overflow-hidden">
                ...
                <div className="flex-1 overflow-hidden h-full flex items-center ml-3">
                    <div
                        className="flex items-center whitespace-nowrap gap-10 text-[10px] sm:text-[11px] font-semibold text-white/80 uppercase tracking-wide animate-ticker-scroll"
                    ...
                    >
                        {headlines.map((article, i) => (
                            <Link
                                ...
                                className="inline-flex items-center gap-2 hover:text-brand-red transition-colors shrink-0 text-white/80 hover:text-white"
                            >
